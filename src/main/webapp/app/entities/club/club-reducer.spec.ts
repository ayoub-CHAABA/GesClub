...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './club.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLUB_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLUB actions', async () => {
      const expectedActions = [
        {
