...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './meeting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETING_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEETING actions', async () => {
      const expectedActions = [
        {
